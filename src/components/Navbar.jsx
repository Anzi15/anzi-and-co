...
const Navbar = () => {
  ...
  return (
    <nav className={`duration-500 flex fixed w-screen top-0 items-center  px-6 justify-between min-h-[4rem]  ${navAnimatationClass } z-[100]`}>
      <img
        src={logo}
        alt="Logo"
      ...
      <div
        ...
        } gap-6 lg:gap-0 lg:py-0 rounded-b-3xl lg:flex lg:static absolute top-0 w-screen left-0 lg:p-0 lg:bg-transparent items-center flex-col lg:flex-row lg:w-[65%] lg:justify-between justify-center bg-white  overflow-hidden`}
      >
        {/* nav links */}
